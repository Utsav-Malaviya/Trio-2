        ...
        <div className="flex flex-col">
          <div className="flex flex-col lg:flex-row lg:flex-wrap justify-between mb-8 lg:mb-12 gap-8 lg:gap-0">
            ...
            <div className="w-full lg:w-auto mb-6 lg:mb-0 text-center lg:text-left group">
              ...
              <p className="mt-2 font-medium text-gray-600 text-sm max-w-xs mx-auto lg:mx-0">
            ...
            <div className="flex flex-col md:flex-row md:flex-wrap gap-8 lg:gap-20">
              ...
              <div className="text-center md:text-left">
                <h3 className="font-serif font-bold text-xl lg:text-2xl text-gray-800 mb-4 lg:mb-6">
                  Quick Links
                </h3>
                <ul className="space-y-3 lg:space-y-4 font-medium text-base lg:text-lg">
              ...
              <div className="text-center md:text-left">
                ...
                <div className="space-y-2 lg:space-y-3 font-medium text-base lg:text-lg text-gray-600">
          ...
          {/* Copyright */}
          <div className="text-center font-medium text-gray-600 text-base lg:text-lg leading-relaxed">
